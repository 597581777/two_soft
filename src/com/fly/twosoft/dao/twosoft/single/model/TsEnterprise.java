...
public class TsEnterprise implements Serializable {
    public static final String REF_TABLE_ALIAS_enterprise = "a";
     ...
     * This field corresponds to the database table TS_ENTERPRISE
     *
     * @mbggenerated
     */
