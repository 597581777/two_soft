...
public class TsProductHistory implements Serializable {
    public static final String REF_TABLE_ALIAS_productHistory = "h";
     ...
     * This field corresponds to the database table TS_PRODUCT_HISTORY
     *
     * @mbggenerated
     */
